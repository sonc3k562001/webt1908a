...
namespace SoundBoard
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj5_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::SoundBoard.Model.MenuItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::SoundBoard.Model.MenuItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::SoundBoard.Model.MenuItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::SoundBoard.Model.MenuItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Category(global::SoundBoard.Model.SoudCategory obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 89 && columnNumber == 80)
                {
            ...
            IMainPage_Bindings
        {
            ...
            private void Update_MenuItems(global::System.Collections.Generic.List<global::SoundBoard.Model.MenuItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
