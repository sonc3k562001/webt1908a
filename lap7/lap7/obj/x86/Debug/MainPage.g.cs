...
namespace lap7
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj3_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::lap7.Models.Book dataRoot;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 15 && columnNumber == 46)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::lap7.Models.Book) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::lap7.Models.Book)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::lap7.Models.Book obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::lap7.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::lap7.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::lap7.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Books(global::System.Collections.Generic.List<global::lap7.Models.Book> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
